...
class Run extends FlameGame with TapDetector, HasCollisionDetection {
  Run({super.camera});
  ...
  static const _imageAssets = [
    ...
    'Rino/Run (52x34).png',
    'parallax1/plx-13.png',
    'parallax1/plx-12.png',
    'parallax1/plx-14.png',
    'parallax1/plx-11.png',
    'parallax1/plx-8.png',
    'parallax1/plx-1.png',
  ];
  ...
  Future<void> onLoad() async {
    ...
    final parallaxBackground = await loadParallaxComponent(
      [
        ParallaxImageData('parallax1/plx-13.png'),
        ParallaxImageData('parallax1/plx-12.png'),
        ParallaxImageData('parallax1/plx-14.png'),
        ParallaxImageData('parallax1/plx-11.png'),
        ParallaxImageData('parallax1/plx-8.png'),
